...
require (
	...
	github.com/vitaodemolay/album-system/cmd/api/controller v1.0.0
)
...
require (
	...
	github.com/vitaodemolay/album-system/internal/model v1.0.0 // indirect
	github.com/vitaodemolay/album-system/internal/services v1.0.0 // indirect
